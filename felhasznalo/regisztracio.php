        ...
        if (count($eredmeny) > 0) {
            ...
            if ($utasitas->execute()) {
                ...
                $uzenet = 'Üdvözlünk a FordításokK oldalon!
                    ...
                    a következő linkre kattintva: http://forditasokk.probaljaki.hu/felhasznalo/bejelentkezes.php?email=' . $mail . '&hash=' . $hash;
